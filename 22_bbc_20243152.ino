...
#define _INTERVAL_DIST   500  // distance sensor interval (unit: ms)
#define _INTERVAL_SERVO  1000 // servo interval (unit: ms)
#define _INTERVAL_SERIAL 1500 // serial interval (unit: ms)
...
#define _SERVO_ANGLE_DIFF  1000  // Replace with |D - E| degree
#define _SERVO_SPEED       750  // servo speed
